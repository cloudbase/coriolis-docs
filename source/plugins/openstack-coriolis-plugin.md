...
Refer to the [Network Ports Requirements page](../reference/coriolis-network-ports-requirements.md) for the full list of OpenStack services that Coriolis must be able to connect to.
...
[**OpenStack as a source cloud**](../platforms/openstack-as-a-source-cloud.md)

[**OpenStack as a destination cloud**](../platforms/openstack-as-a-destination-cloud.md)
...
Coriolis also offers the option of Ceph backend storage to be used with the two features of **Ceph Snapshots** and **Ceph Backups** for **Replica and Migration** tasks. For more information on this option, please go to **[Coriolis OpenStack Ceph integration](../platform-notes/openstack-ceph-integration.md)** page.
...
Please check the **[Known issues page](../platform-notes/openstack-known-issues.md)** for some known issues and their workaround.
