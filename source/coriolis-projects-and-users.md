...
[![](_static/images/new-project-1.2.jpg)](https://i0.wp.com/cloudbase.it/wp-content/uploads/2021/03/new-project-1.2.jpg?ssl=1)

When creating a new User, the mandatory fields that need to be filled in, will be the **Username** , a **Password** for the new user and select the **Primary Project** for the new user.  
There will also be the option to have the user as enabled or not once it is created.

[![](_static/images/new-user.jpg)](https://i0.wp.com/cloudbase.it/wp-content/uploads/2021/03/new-user.jpg?ssl=1)
